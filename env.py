...
class Environment(tk.Tk, object):
    ...
    def build_environment(self):
        ...
        self.obstacle1 = self.canvas_widget.create_image(pixels * 3, pixels * 9, anchor='nw', image=self.obstacle8_object)
        # Obstacle 2
        self.obstacle2 = self.canvas_widget.create_image(0, pixels * 2, anchor='nw', image=self.obstacle2_object)
        # Obstacle 3
        ...
        # Obstacle 7
        self.obstacle7 = self.canvas_widget.create_image(pixels * 5, pixels * 1, anchor='nw', image=self.obstacle3_object)
        # Obstacle 8
        self.obstacle8 = self.canvas_widget.create_image(pixels * 6, pixels, anchor='nw', image=self.obstacle10_object)
        # Obstacle 9
        self.obstacle9 = self.canvas_widget.create_image(pixels * 5, pixels * 4, anchor='nw', image=self.obstacle2_object)
        # Obstacle 10
        self.obstacle10 = self.canvas_widget.create_image(pixels * 4, pixels * 5, anchor='nw', image=self.obstacle7_object)
        # Obstacle 11
        self.obstacle11 = self.canvas_widget.create_image(pixels * 5, pixels * 6, anchor='nw', image=self.obstacle12_object)
        # Obstacle 12
        self.obstacle12 = self.canvas_widget.create_image(pixels * 5, pixels * 8, anchor='nw', image=self.obstacle11_object)
        # Obstacle 13
        self.obstacle13 = self.canvas_widget.create_image(0, pixels * 8, anchor='nw', image=self.obstacle4_object)
        # Obstacle 14
        self.obstacle14 = self.canvas_widget.create_image(pixels * 3, pixels * 6, anchor='nw', image=self.obstacle9_object)
        # Obstacle 15
        self.obstacle15 = self.canvas_widget.create_image(0, pixels * 4, anchor='nw', image=self.obstacle1_object)
        # Obstacle 16
        self.obstacle16 = self.canvas_widget.create_image(pixels * 8, 0, anchor='nw', image=self.obstacle2_object)
        # Obstacle 17
        self.obstacle17 = self.canvas_widget.create_image(pixels * 7, pixels * 7, anchor='nw', image=self.obstacle1_object)
        # Obstacle 18
        self.obstacle18 = self.canvas_widget.create_image(pixels, pixels * 6, anchor='nw', image=self.obstacle11_object)
        # Obstacle 19
        self.obstacle19 = self.canvas_widget.create_image(pixels * 8, pixels * 3, anchor='nw', image=self.obstacle4_object)
        # Obstacle 20
        self.obstacle20 = self.canvas_widget.create_image(pixels * 7, pixels * 1, anchor='nw', image=self.obstacle4_object)
        # Obstacle 21
        self.obstacle21 = self.canvas_widget.create_image(pixels * 7, pixels * 2, anchor='nw', image=self.obstacle7_object)
        # Obstacle 22
        self.obstacle22 = self.canvas_widget.create_image(pixels * 6, pixels * 3, anchor='nw', image=self.obstacle1_object)
